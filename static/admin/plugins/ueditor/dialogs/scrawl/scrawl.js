...
(function () {
    ...
    scrawl.prototype = {
        ...
        initOptions:function (options) {
            ...
            me._addBoardListener(options.saveNum);//Novo Registro画板处理
            me._addOPerateListener(options.saveNum);//Novo Registroundo redo clearBoard处理
            me._addColorBarListener();//Novo Registro颜色选择处理
            me._addBrushBarListener();//Novo Registro画笔大小处理
            me._addEraserBarListener();//Novo Registro橡皮大小处理
            me._addAddImgListener();//Novo Registro增添背景图片处理
            me._addRemoveImgListenter();//删除背景图片处理
            me._addScalePicListenter();//Novo Registro缩放处理
            me._addClearSelectionListenter();//Novo Registro清楚选中状态处理
