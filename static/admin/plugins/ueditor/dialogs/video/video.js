...
(function(){
    ...
    /**
     * 找到id下具有focus类的节点并Retornar该节点下的某个属性
     * @param id
    ...
    /**
      * 检测传入的所有input框中输入的长宽SimNãoSim正数
    ...
    UploadFile.prototype = {
        ...
        initUploader: function () {
            ...
            // 当有文件Novo Registro进来时执行，负责view的创建
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
                //这里可以通过data对象Novo RegistroPOST参数
