...
type UserLevel struct {
	...
	Name        string `orm:"column(name);size(20)" description:"Nome" json:"name"`
	Description string `orm:"column(description);size(50)" description:"Descrição" json:"description"`
	Img         string `orm:"column(img);size(255)" description:"图片" json:"img"`
	Status      int8   `orm:"column(status);size(1);default(1)" description:"Ativo 0：Não 1：Sim" json:"status"`
