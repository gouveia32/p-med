...
func (ic *IndexController) Index() {
	...
	//Quantidade de registros do Paciente
	var pacienteService services.PacienteService
	ic.Data["paciente_count"] = pacienteService.GetCount()
	//Quantidade de registros do atendimento
	var atendimentoService services.AtendimentoService
	ic.Data["atendimento_count"] = atendimentoService.GetCount()
	//Quantidade de registros de notas
	var notaService services.NotaService
	ic.Data["nota_count"] = notaService.GetCount()	
	//后台用户数量
